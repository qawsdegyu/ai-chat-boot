...
var import_pg_core, import_drizzle_orm, import_pg_core2, users, inventoryRecords, auditLogs, aiConversations, aiMessages, userOauthConnections, uploadedFiles, onedriveFiles, onedriveIndexedData, fileIngestionRuns, fileSheets, fileCells, fileCellSources;
var init_schema = __esm({
  "drizzle/schema.ts"() {
    ...
    users = (0, import_pg_core.pgTable)("users", {
      ...
      openId: (0, import_pg_core.text)("openId").notNull().unique(),
      name: (0, import_pg_core.text)("name"),
      email: (0, import_pg_core.text)("email"),
      loginMethod: (0, import_pg_core.text)("loginMethod"),
    ...
    inventoryRecords = (0, import_pg_core.pgTable)("inventory_records", {
      id: (0, import_pg_core.serial)("id").primaryKey(),
      source: (0, import_pg_core.text)("source").notNull(),
      country: (0, import_pg_core.text)("country").notNull().default(""),
      city: (0, import_pg_core.text)("city").notNull().default(""),
      routerName: (0, import_pg_core.text)("routerName").notNull(),
      oldRouterName: (0, import_pg_core.text)("oldRouterName").notNull().default(""),
      siteId: (0, import_pg_core.text)("siteId").notNull().default(""),
      subnetIp: (0, import_pg_core.text)("subnetIp").notNull().default(""),
      contactDetails: (0, import_pg_core.text)("contactDetails"),
      location: (0, import_pg_core.text)("location"),
      operationalHours: (0, import_pg_core.text)("operationalHours"),
      proactiveEmailContacts: (0, import_pg_core.text)("proactiveEmailContacts"),
      switchName: (0, import_pg_core.text)("switchName").notNull().default(""),
      mcsStatus: (0, import_pg_core.text)("mcsStatus").notNull().default(""),
      circuitType: (0, import_pg_core.text)("circuitType").notNull().default(""),
      migrationStatus: (0, import_pg_core.text)("migrationStatus").notNull(),
      serialNumber: (0, import_pg_core.text)("serialNumber").notNull().default(""),
      fromProductId: (0, import_pg_core.text)("fromProductId").notNull().default(""),
      rack: (0, import_pg_core.text)("rack").notNull().default(""),
      port: (0, import_pg_core.text)("port").notNull().default(""),
      vlan: (0, import_pg_core.text)("vlan").notNull().default(""),
      toVlan: (0, import_pg_core.text)("toVlan").notNull().default(""),
      createdAt: (0, import_pg_core.timestamp)("createdAt").defaultNow().notNull(),
      updatedAt: (0, import_pg_core.timestamp)("updatedAt").defaultNow().notNull()
    });
    auditLogs = (0, import_pg_core.pgTable)("audit_logs", {
      ...
      userName: (0, import_pg_core.text)("userName").notNull().default("System"),
      action: (0, import_pg_core.text)("action").notNull(),
      entityType: (0, import_pg_core.text)("entityType").notNull(),
    ...
    aiConversations = (0, import_pg_core.pgTable)("ai_conversations", {
      id: (0, import_pg_core.serial)("id").primaryKey(),
      userId: (0, import_pg_core.integer)("userId").notNull(),
      title: (0, import_pg_core.text)("title").notNull().default("New AI conversation"),
      createdAt: (0, import_pg_core.timestamp)("createdAt").defaultNow().notNull(),
      updatedAt: (0, import_pg_core.timestamp)("updatedAt").defaultNow().notNull(),
      archivedAt: (0, import_pg_core.timestamp)("archivedAt")
    });
    aiMessages = (0, import_pg_core.pgTable)("ai_messages", {
      id: (0, import_pg_core.serial)("id").primaryKey(),
    ...
    userOauthConnections = (0, import_pg_core.pgTable)("user_oauth_connections", {
      id: (0, import_pg_core.serial)("id").primaryKey(),
      userId: (0, import_pg_core.integer)("userId").notNull(),
      provider: (0, import_pg_core.text)("provider").notNull(),
      // 'microsoft'
      accountId: (0, import_pg_core.text)("accountId"),
      // Microsoft user ID
      accountEmail: (0, import_pg_core.text)("accountEmail"),
      accessToken: (0, import_pg_core.text)("accessToken"),
      refreshToken: (0, import_pg_core.text)("refreshToken"),
      expiresAt: (0, import_pg_core.timestamp)("expiresAt"),
      createdAt: (0, import_pg_core.timestamp)("createdAt").defaultNow().notNull(),
      updatedAt: (0, import_pg_core.timestamp)("updatedAt").defaultNow().notNull()
    });
    uploadedFiles = (0, import_pg_core.pgTable)("uploaded_files", {
      id: (0, import_pg_core.serial)("id").primaryKey(),
      userId: (0, import_pg_core.integer)("userId"),
      fileName: (0, import_pg_core.text)("fileName").notNull(),
      originalFilename: (0, import_pg_core.text)("originalFilename").notNull(),
      content: (0, import_pg_core.text)("content").notNull(),
      createdAt: (0, import_pg_core.timestamp)("createdAt").defaultNow().notNull(),
      updatedAt: (0, import_pg_core.timestamp)("updatedAt").defaultNow().notNull(),
      storagePath: (0, import_pg_core.text)("storagePath"),
      mimeType: (0, import_pg_core.text)("mimeType"),
      fileSize: (0, import_pg_core.integer)("fileSize"),
      fileExtension: (0, import_pg_core.text)("fileExtension"),
      uploadStatus: (0, import_pg_core.text)("uploadStatus").default("ready"),
      processingError: (0, import_pg_core.text)("processingError"),
      sheetCount: (0, import_pg_core.integer)("sheetCount"),
      sheetNames: (0, import_pg_core.text)("sheetNames"),
      sha256Hash: (0, import_pg_core.text)("sha256Hash"),
      missingSheets: (0, import_pg_core.jsonb)("missingSheets"),
      workbookHasVba: (0, import_pg_core.boolean)("workbookHasVba"),
      workbookMetadata: (0, import_pg_core.jsonb)("workbookMetadata"),
      // OneDrive Integration Fields
      sourceType: (0, import_pg_core.text)("sourceType").default("local"),
      externalId: (0, import_pg_core.text)("externalId"),
      webUrl: (0, import_pg_core.text)("webUrl"),
      eTag: (0, import_pg_core.text)("eTag"),
      lastSyncDate: (0, import_pg_core.timestamp)("lastSyncDate")
    });
    onedriveFiles = (0, import_pg_core.pgTable)("onedrive_files", {
      id: (0, import_pg_core.serial)("id").primaryKey(),
      userId: (0, import_pg_core.integer)("userId").notNull(),
      driveItemId: (0, import_pg_core.text)("driveItemId").notNull().unique(),
      name: (0, import_pg_core.text)("name").notNull(),
      webUrl: (0, import_pg_core.text)("webUrl"),
      parentPath: (0, import_pg_core.text)("parentPath"),
      sizeBytes: (0, import_pg_core.integer)("sizeBytes"),
      eTag: (0, import_pg_core.text)("eTag"),
      lastModifiedDateTime: (0, import_pg_core.timestamp)("lastModifiedDateTime"),
      status: (0, import_pg_core.text)("status").notNull().default("discovered"),
      // discovered, selected, syncing, processing, active, failed, archived
      sheetCount: (0, import_pg_core.integer)("sheetCount").default(0),
      indexedRows: (0, import_pg_core.integer)("indexedRows").default(0),
      indexedCells: (0, import_pg_core.integer)("indexedCells").default(0),
      lastSyncTime: (0, import_pg_core.timestamp)("lastSyncTime"),
      lastError: (0, import_pg_core.text)("lastError"),
      createdAt: (0, import_pg_core.timestamp)("createdAt").defaultNow().notNull(),
      updatedAt: (0, import_pg_core.timestamp)("updatedAt").defaultNow().notNull()
    });
    onedriveIndexedData = (0, import_pg_core.pgTable)("onedrive_indexed_data", {
      id: (0, import_pg_core.serial)("id").primaryKey(),
      internalFileId: (0, import_pg_core.integer)("internalFileId"),
      driveItemId: (0, import_pg_core.text)("driveItemId").notNull(),
      eTag: (0, import_pg_core.text)("eTag"),
      fileName: (0, import_pg_core.text)("fileName"),
      sheetName: (0, import_pg_core.text)("sheetName").notNull(),
      rowIndex: (0, import_pg_core.integer)("rowIndex"),
      cellAddress: (0, import_pg_core.text)("cellAddress"),
      content: (0, import_pg_core.text)("content").notNull()
    });
    fileIngestionRuns = (0, import_pg_core.pgTable)("file_ingestion_runs", {
      id: (0, import_pg_core.serial)("id").primaryKey(),
      file_id: (0, import_pg_core.integer)("file_id"),
      requested_by: (0, import_pg_core.text)("requested_by"),
      status: (0, import_pg_core.text)("status"),
      parser_name: (0, import_pg_core.text)("parser_name"),
      parser_version: (0, import_pg_core.text)("parser_version"),
      actual_sheet_count: (0, import_pg_core.integer)("actual_sheet_count"),
      indexed_sheet_count: (0, import_pg_core.integer)("indexed_sheet_count"),
      cells_seen: (0, import_pg_core.integer)("cells_seen"),
      cells_indexed: (0, import_pg_core.integer)("cells_indexed"),
      matches_ready: (0, import_pg_core.integer)("matches_ready"),
      error_message: (0, import_pg_core.text)("error_message"),
      started_at: (0, import_pg_core.timestamp)("started_at"),
      finished_at: (0, import_pg_core.timestamp)("finished_at"),
      created_at: (0, import_pg_core.timestamp)("created_at").defaultNow().notNull()
    });
    fileSheets = (0, import_pg_core.pgTable)("file_sheets", {
      id: (0, import_pg_core.serial)("id").primaryKey(),
      file_id: (0, import_pg_core.integer)("file_id"),
      ingestion_run_id: (0, import_pg_core.integer)("ingestion_run_id"),
      sheet_name: (0, import_pg_core.text)("sheet_name"),
      sheet_order: (0, import_pg_core.integer)("sheet_order"),
      sheet_state: (0, import_pg_core.text)("sheet_state"),
      dimension_ref: (0, import_pg_core.text)("dimension_ref"),
      max_row: (0, import_pg_core.integer)("max_row"),
      max_column: (0, import_pg_core.integer)("max_column"),
      row_count: (0, import_pg_core.integer)("row_count"),
      cell_count: (0, import_pg_core.integer)("cell_count"),
      formula_count: (0, import_pg_core.integer)("formula_count"),
      hyperlink_count: (0, import_pg_core.integer)("hyperlink_count"),
      merged_ranges: (0, import_pg_core.jsonb)("merged_ranges"),
      sheet_metadata: (0, import_pg_core.jsonb)("sheet_metadata")
    });
    fileCells = (0, import_pg_core.pgTable)("file_cells", {
      id: (0, import_pg_core.serial)("id").primaryKey(),
      file_id: (0, import_pg_core.integer)("file_id"),
      sheet_id: (0, import_pg_core.integer)("sheet_id"),
      ingestion_run_id: (0, import_pg_core.integer)("ingestion_run_id"),
      cell_address: (0, import_pg_core.text)("cell_address"),
      row_number: (0, import_pg_core.integer)("row_number"),
      column_number: (0, import_pg_core.integer)("column_number"),
      column_letter: (0, import_pg_core.text)("column_letter"),
      column_header: (0, import_pg_core.text)("column_header"),
      cell_type: (0, import_pg_core.text)("cell_type"),
      raw_value: (0, import_pg_core.text)("raw_value"),
      calculated_value: (0, import_pg_core.text)("calculated_value"),
      numeric_value: (0, import_pg_core.doublePrecision)("numeric_value"),
      date_value: (0, import_pg_core.timestamp)("date_value"),
      boolean_value: (0, import_pg_core.boolean)("boolean_value"),
      formula: (0, import_pg_core.text)("formula"),
      formula_result_type: (0, import_pg_core.text)("formula_result_type"),
      is_formula: (0, import_pg_core.boolean)("is_formula"),
      is_blank: (0, import_pg_core.boolean)("is_blank"),
      normalized_text: (0, import_pg_core.text)("normalized_text"),
      source_method: (0, import_pg_core.text)("source_method"),
      source_metadata: (0, import_pg_core.jsonb)("source_metadata"),
      hyperlink_target: (0, import_pg_core.text)("hyperlink_target"),
      hyperlink_location: (0, import_pg_core.text)("hyperlink_location"),
      comment_text: (0, import_pg_core.text)("comment_text"),
      style_metadata: (0, import_pg_core.jsonb)("style_metadata")
    });
    fileCellSources = (0, import_pg_core2.pgView)("file_cell_sources").as((qb) => {
      return qb.select({
      ...
      }).from(fileCells).innerJoin(fileSheets, import_drizzle_orm.sql`${fileCells.sheet_id} = ${fileSheets.id}`).innerJoin(uploadedFiles, import_drizzle_orm.sql`${fileCells.file_id} = ${uploadedFiles.id}`);
    });
  }
});
  ...
  if (!_dbPromise) {
    _dbPromise = (async () => {
      try {
        ...
        const dbInstance = (0, import_postgres_js.drizzle)(client);
        try {
          await dbInstance.execute(import_drizzle_orm2.sql`
...
var import_drizzle_orm2, import_postgres_js, import_postgres, _dbPromise;
var init_db = __esm({
  "server/db.ts"() {
    "use strict";
...
async function getStoredInventory(range = {}) {
  ...
  if (!db) return [];
  const conditions = [];
  if (range.from) conditions.push((0, import_drizzle_orm3.gte)(inventoryRecords.createdAt, range.from));
  if (range.to) conditions.push((0, import_drizzle_orm3.lte)(inventoryRecords.createdAt, range.to));
  return db.select().from(inventoryRecords).where(conditions.length ? (0, import_drizzle_orm3.and)(...conditions) : void 0).orderBy(inventoryRecords.routerName);
}
...
async function replaceImportedInventory(rows, actor) {
  ...
  if (source === "NewInventory") {
    await db.delete(inventoryRecords).where(
      (0, import_drizzle_orm3.or)(
        (0, import_drizzle_orm3.eq)(inventoryRecords.source, "NewInventory"),
        (0, import_drizzle_orm3.ilike)(inventoryRecords.source, "%new%"),
        (0, import_drizzle_orm3.ilike)(inventoryRecords.source, "%migrated%")
      )
    );
  } else {
    await db.delete(inventoryRecords).where(
      (0, import_drizzle_orm3.and)(
        (0, import_drizzle_orm3.not)((0, import_drizzle_orm3.eq)(inventoryRecords.source, "NewInventory")),
        (0, import_drizzle_orm3.not)((0, import_drizzle_orm3.ilike)(inventoryRecords.source, "%new%")),
        (0, import_drizzle_orm3.not)((0, import_drizzle_orm3.ilike)(inventoryRecords.source, "%migrated%"))
      )
    );
  }
  ...
  for (const row of referenceRows) {
    ...
    if (row.migrationStatus !== status) await db.update(inventoryRecords).set({ migrationStatus: status }).where((0, import_drizzle_orm3.eq)(inventoryRecords.id, row.id));
  }
...
async function listAuditLogs(filters = {}) {
  ...
  if (!db) return [];
  const conditions = [];
  if (filters.userName && filters.userName !== "all") conditions.push((0, import_drizzle_orm3.eq)(auditLogs.userName, filters.userName));
  if (filters.action && filters.action !== "all") conditions.push((0, import_drizzle_orm3.eq)(auditLogs.action, filters.action));
  return db.select().from(auditLogs).where(conditions.length ? (0, import_drizzle_orm3.and)(...conditions) : void 0).orderBy((0, import_drizzle_orm3.desc)(auditLogs.createdAt)).limit(filters.limit ?? 100);
}
async function searchStoredInventory(input) {
  ...
  if (search) {
    const term = `%${search}%`;
    conditions.push((0, import_drizzle_orm3.or)((0, import_drizzle_orm3.ilike)(inventoryRecords.routerName, term), (0, import_drizzle_orm3.ilike)(inventoryRecords.oldRouterName, term), (0, import_drizzle_orm3.ilike)(inventoryRecords.siteId, term), (0, import_drizzle_orm3.ilike)(inventoryRecords.country, term), (0, import_drizzle_orm3.ilike)(inventoryRecords.city, term), (0, import_drizzle_orm3.ilike)(inventoryRecords.contactDetails, term), (0, import_drizzle_orm3.ilike)(inventoryRecords.location, term)));
  }
  if (input.country && input.country !== "all") conditions.push((0, import_drizzle_orm3.eq)(inventoryRecords.country, input.country));
  if (input.city && input.city !== "all") conditions.push((0, import_drizzle_orm3.eq)(inventoryRecords.city, input.city));
  if (input.migrationStatus && input.migrationStatus !== "all") conditions.push((0, import_drizzle_orm3.eq)(inventoryRecords.migrationStatus, input.migrationStatus));
  if (input.circuitType && input.circuitType !== "all") conditions.push((0, import_drizzle_orm3.eq)(inventoryRecords.circuitType, input.circuitType));
  return db.select().from(inventoryRecords).where(conditions.length ? (0, import_drizzle_orm3.and)(...conditions) : void 0).orderBy(inventoryRecords.routerName);
}
async function updateStoredInventoryRecord(id, data) {
  const db = await getDb();
  if (!db) return false;
  await db.update(inventoryRecords).set(data).where((0, import_drizzle_orm3.eq)(inventoryRecords.id, id));
  return true;
}
...
async function deleteStoredInventoryRecord(id) {
  const db = await getDb();
  if (!db) return false;
  await db.delete(inventoryRecords).where((0, import_drizzle_orm3.eq)(inventoryRecords.id, id));
  return true;
}
...
async function storedInventoryStats() {
  const db = await getDb();
  if (!db) return null;
  const [total] = await db.select({ count: import_drizzle_orm3.sql`count(*)` }).from(inventoryRecords);
  const [migrated] = await db.select({ count: import_drizzle_orm3.sql`count(*)` }).from(inventoryRecords).where((0, import_drizzle_orm3.eq)(inventoryRecords.migrationStatus, "Migrated"));
  const [notMigrated] = await db.select({ count: import_drizzle_orm3.sql`count(*)` }).from(inventoryRecords).where((0, import_drizzle_orm3.eq)(inventoryRecords.migrationStatus, "Not Migrated"));
  const countries = await db.select({ country: inventoryRecords.country, count: import_drizzle_orm3.sql`count(*)` }).from(inventoryRecords).groupBy(inventoryRecords.country).orderBy((0, import_drizzle_orm3.desc)(import_drizzle_orm3.sql`count(*)`));
...
var import_drizzle_orm3, AUDITED_ACTIONS;
...
async function listUsers() {
  const db = await getDb();
  if (!db) return [];
  return db.select({ id: users.id, name: users.name, email: users.email, role: users.role, lastSignedIn: users.lastSignedIn, createdAt: users.createdAt }).from(users).orderBy((0, import_drizzle_orm4.asc)(users.name));
}
...
async function updateUserRole(targetUserId, role, actor) {
  const db = await getDb();
  if (!db) throw new Error("Database is not available");
  const [target] = await db.select({ id: users.id, name: users.name, role: users.role }).from(users).where((0, import_drizzle_orm4.eq)(users.id, targetUserId)).limit(1);
  if (!target) throw new Error("User not found");
  await db.update(users).set({ role }).where((0, import_drizzle_orm4.eq)(users.id, targetUserId));
...
async function deleteUser(targetUserId, actor) {
  ...
  const [target] = await db.select({ id: users.id, name: users.name }).from(users).where((0, import_drizzle_orm4.eq)(users.id, targetUserId)).limit(1);
  if (!target) throw new Error("User not found");
  await db.delete(users).where((0, import_drizzle_orm4.eq)(users.id, targetUserId));
...
async function appendConversationMessage(userId, conversationId, role, content) {
  const db = await getDb();
  if (!db) throw new Error("Database is not available");
  const [conversation] = await db.select().from(aiConversations).where((0, import_drizzle_orm5.and)((0, import_drizzle_orm5.eq)(aiConversations.id, conversationId), (0, import_drizzle_orm5.eq)(aiConversations.userId, userId))).limit(1);
  ...
  await db.update(aiConversations).set({ updatedAt: /* @__PURE__ */ new Date() }).where((0, import_drizzle_orm5.eq)(aiConversations.id, conversationId));
  return { success: true };
}
async function listUserConversations(userId, archivedOnly = false) {
  const db = await getDb();
  if (!db) return [];
  const scope = archivedOnly ? (0, import_drizzle_orm5.and)((0, import_drizzle_orm5.eq)(aiConversations.userId, userId), (0, import_drizzle_orm5.isNotNull)(aiConversations.archivedAt)) : (0, import_drizzle_orm5.and)((0, import_drizzle_orm5.eq)(aiConversations.userId, userId), (0, import_drizzle_orm5.isNull)(aiConversations.archivedAt));
  return db.select().from(aiConversations).where(scope).orderBy((0, import_drizzle_orm5.desc)(aiConversations.updatedAt));
}
async function setConversationArchived(userId, conversationId, archived) {
  ...
  const [conversation] = await db.select().from(aiConversations).where((0, import_drizzle_orm5.and)((0, import_drizzle_orm5.eq)(aiConversations.id, conversationId), (0, import_drizzle_orm5.eq)(aiConversations.userId, userId))).limit(1);
  if (!ownsConversation(conversation, userId)) throw new Error("Conversation not found");
  await db.update(aiConversations).set({ archivedAt: archived ? /* @__PURE__ */ new Date() : null }).where((0, import_drizzle_orm5.eq)(aiConversations.id, conversationId));
  return { success: true };
}
async function deleteConversation(userId, conversationId) {
  ...
  const [conversation] = await db.select().from(aiConversations).where((0, import_drizzle_orm5.and)((0, import_drizzle_orm5.eq)(aiConversations.id, conversationId), (0, import_drizzle_orm5.eq)(aiConversations.userId, userId))).limit(1);
  if (!ownsConversation(conversation, userId)) throw new Error("Conversation not found");
  await db.delete(aiMessages).where((0, import_drizzle_orm5.and)((0, import_drizzle_orm5.eq)(aiMessages.conversationId, conversationId), (0, import_drizzle_orm5.eq)(aiMessages.userId, userId)));
  await db.delete(aiConversations).where((0, import_drizzle_orm5.eq)(aiConversations.id, conversationId));
  return { success: true };
}
async function getUserConversation(userId, conversationId) {
  ...
  const messages = await db.select().from(aiMessages).where((0, import_drizzle_orm5.and)((0, import_drizzle_orm5.eq)(aiMessages.conversationId, conversationId), (0, import_drizzle_orm5.eq)(aiMessages.userId, userId))).orderBy(aiMessages.createdAt);
...
async function getAllAiMessages() {
  ...
  }).from(aiMessages).leftJoin(users2, (0, import_drizzle_orm5.eq)(aiMessages.userId, users2.id)).orderBy((0, import_drizzle_orm5.desc)(aiMessages.createdAt)).limit(1e3);
}
var import_drizzle_orm5;
...
var import_axios, import_cookie, import_jose, isNonEmptyString2, EXCHANGE_TOKEN_PATH, GET_USER_INFO_PATH, GET_USER_INFO_WITH_JWT_PATH, OAuthService, createOAuthHttpClient, SDKServer, CRON_OPEN_ID_PREFIX, sdk;
var init_sdk = __esm({
  "server/_core/sdk.ts"() {
    "use strict";
    init_const();
...
function registerMicrosoftOAuthRoutes(app2) {
  ...
  app2.get("/api/auth/microsoft", (req, res) => {
    const state = (0, import_nanoid.nanoid)();
  ...
  app2.get("/api/auth/microsoft/callback", async (req, res) => {
    ...
    const cookies = req.headers.cookie ? import_cookie2.default.parse(req.headers.cookie) : {};
    ...
    try {
      ...
      const existing = await db.select().from(userOauthConnections).where((0, import_drizzle_orm6.eq)(userOauthConnections.userId, user.id)).limit(1);
      if (existing.length > 0) {
        ...
        }).where((0, import_drizzle_orm6.eq)(userOauthConnections.id, existing[0].id));
      } else {
...
var import_drizzle_orm6, import_nanoid, import_cookie2;
var init_microsoftOAuth = __esm({
  "server/microsoftOAuth.ts"() {
    ...
    import_cookie2 = __toESM(require("cookie"), 1);
  }
});
...
async function indexOneDriveFileBackground(driveItemId, accessToken) {
  try {
    const db = await getDb();
    if (!db) return;
    await db.update(onedriveFiles).set({ status: "processing", lastError: null }).where((0, import_drizzle_orm7.eq)(onedriveFiles.driveItemId, driveItemId));
    ...
    await db.update(onedriveFiles).set({ eTag: meta.eTag, lastModifiedDateTime: new Date(meta.lastModifiedDateTime), sizeBytes: meta.size }).where((0, import_drizzle_orm7.eq)(onedriveFiles.driveItemId, driveItemId));
    ...
    const fileRecord = await db.select({ id: onedriveFiles.id }).from(onedriveFiles).where((0, import_drizzle_orm7.eq)(onedriveFiles.driveItemId, driveItemId)).limit(1);
    ...
    }).where((0, import_drizzle_orm7.eq)(onedriveFiles.driveItemId, driveItemId));
    ...
    try {
      const db = await getDb();
      if (db) {
        await db.update(onedriveFiles).set({ status: "failed", lastError: err.message }).where((0, import_drizzle_orm7.eq)(onedriveFiles.driveItemId, driveItemId));
      }
    } catch (e) {
    }
  }
...
if (typeof globalThis.require === "undefined") {
  globalThis.require = (0, import_module.createRequire)(import_meta.url);
}
var inventoryInput = import_zod2.z.object({ search: import_zod2.z.string().optional(), country: import_zod2.z.string().optional(), city: import_zod2.z.string().optional(), migrationStatus: import_zod2.z.string().optional(), circuitType: import_zod2.z.string().optional() });
var adminProcedure2 = protectedProcedure.use(({ ctx, next }) => {
  if (ctx.user.role !== "admin") throw new import_server3.TRPCError({ code: "FORBIDDEN", message: "Administrator access is required." });
  return next();
});
var cell = (row, keys) => {
...
var appRouter = router({
  ...
  auth: router({
    ...
    localLogin: publicProcedure.input(import_zod2.z.object({ email: import_zod2.z.string().email(), password: import_zod2.z.string() })).mutation(async ({ input, ctx }) => {
      const { createClient } = await import("@supabase/supabase-js");
      const { ENV: ENV2 } = await Promise.resolve().then(() => (init_env(), env_exports));
      if (!process.env.VITE_SUPABASE_URL || !process.env.VITE_SUPABASE_ANON_KEY) {
        throw new import_server3.TRPCError({ code: "INTERNAL_SERVER_ERROR", message: "Supabase configuration is missing in .env file" });
      }
      ...
      if (error || !data.user) {
        throw new import_server3.TRPCError({ code: "UNAUTHORIZED", message: error?.message || "Invalid email or password" });
      }
  ...
  ai: router({
    conversations: protectedProcedure.input(import_zod2.z.object({ archivedOnly: import_zod2.z.boolean().optional() }).optional()).query(({ ctx, input }) => listUserConversations(ctx.user.id, input?.archivedOnly ?? false)),
    archiveConversation: protectedProcedure.input(import_zod2.z.object({ conversationId: import_zod2.z.number().int().positive(), archived: import_zod2.z.boolean() })).mutation(({ ctx, input }) => setConversationArchived(ctx.user.id, input.conversationId, input.archived)),
    deleteConversation: protectedProcedure.input(import_zod2.z.object({ conversationId: import_zod2.z.number().int().positive() })).mutation(({ ctx, input }) => deleteConversation(ctx.user.id, input.conversationId)),
    conversation: protectedProcedure.input(import_zod2.z.object({ conversationId: import_zod2.z.number().int().positive() })).query(({ input, ctx }) => getUserConversation(ctx.user.id, input.conversationId)),
    ask: protectedProcedure.input(import_zod2.z.object({ question: import_zod2.z.string().min(2).max(1e3), conversationId: import_zod2.z.number().int().positive().optional(), fileId: import_zod2.z.number().int().optional(), onedriveFileIds: import_zod2.z.array(import_zod2.z.string()).optional(), language: import_zod2.z.enum(["ar", "en"]).default("en") })).mutation(async ({ input, ctx }) => {
  ...
  inventory: router({
    ...
    importExcel: adminProcedure2.input(import_zod2.z.object({ fileBase64: import_zod2.z.string().min(20), fileName: import_zod2.z.string().min(1), sourceType: import_zod2.z.string() })).mutation(async ({ input, ctx }) => {
    ...
    processUploadedFile: adminProcedure2.input(import_zod2.z.object({
      fileName: import_zod2.z.string().min(1),
      storagePath: import_zod2.z.string().min(1),
      mimeType: import_zod2.z.string(),
      fileSize: import_zod2.z.number().int()
    })).mutation(async ({ input, ctx }) => {
      const { getDb: getDb2 } = await Promise.resolve().then(() => (init_db(), db_exports));
      const db = await getDb2();
      if (!db) throw new import_server3.TRPCError({ code: "INTERNAL_SERVER_ERROR", message: "Database not available" });
      ...
      if (!newFile) throw new import_server3.TRPCError({ code: "INTERNAL_SERVER_ERROR", message: "Failed to insert file record" });
      ...
      try {
        ...
        throw new import_server3.TRPCError({ code: "INTERNAL_SERVER_ERROR", message: `Processing failed: ${err.message}` });
      }
      const { sql: sql4 } = await import("drizzle-orm");
    ...
    updateRecord: adminProcedure2.input(import_zod2.z.object({ id: import_zod2.z.number().int().positive(), data: import_zod2.z.record(import_zod2.z.string(), import_zod2.z.any()) })).mutation(async ({ input }) => {
      const success = await updateStoredInventoryRecord(input.id, input.data);
      if (!success) throw new import_server3.TRPCError({ code: "INTERNAL_SERVER_ERROR", message: "Failed to update record" });
      return { success: true };
    }),
    addRecord: adminProcedure2.input(import_zod2.z.record(import_zod2.z.string(), import_zod2.z.any())).mutation(async ({ input }) => {
      const { addStoredInventoryRecord: addStoredInventoryRecord2 } = await Promise.resolve().then(() => (init_inventoryDb(), inventoryDb_exports));
      if (!input.routerName) throw new import_server3.TRPCError({ code: "BAD_REQUEST", message: "Router Name is required" });
      const data = {
      ...
      if (!success) throw new import_server3.TRPCError({ code: "INTERNAL_SERVER_ERROR", message: "Failed to add record" });
      return { success: true };
    }),
    deleteRecord: adminProcedure2.input(import_zod2.z.object({ id: import_zod2.z.number().int().positive() })).mutation(async ({ input }) => {
      ...
      if (!success) throw new import_server3.TRPCError({ code: "INTERNAL_SERVER_ERROR", message: "Failed to delete record" });
      return { success: true };
    })
  }),
  report: router({ migration: protectedProcedure.input(import_zod2.z.object({ language: import_zod2.z.enum(["ar", "en"]).default("en"), from: import_zod2.z.string().datetime().optional(), to: import_zod2.z.string().datetime().optional() })).query(({ input }) => getMigrationReport(input.language, { from: input.from ? new Date(input.from) : void 0, to: input.to ? new Date(input.to) : void 0 })) }),
  audit: router({ list: adminProcedure2.input(import_zod2.z.object({ userName: import_zod2.z.string().optional(), action: import_zod2.z.string().optional(), limit: import_zod2.z.number().int().positive().max(500).optional() }).optional()).query(({ input }) => listAuditLogs(input ?? {})) }),
  admin: router({
    ...
    createUser: adminProcedure2.input(import_zod2.z.object({ name: import_zod2.z.string().min(1), email: import_zod2.z.string().email(), password: import_zod2.z.string().min(6), role: import_zod2.z.enum(["admin", "user"]) })).mutation(async ({ input }) => {
      const { createClient } = require("@supabase/supabase-js");
      const supabase = createClient(process.env.VITE_SUPABASE_URL, process.env.VITE_SUPABASE_ANON_KEY);
      const { data, error } = await supabase.auth.signUp({ email: input.email, password: input.password });
      if (error) throw new import_server3.TRPCError({ code: "BAD_REQUEST", message: error.message });
      if (!data.user) throw new import_server3.TRPCError({ code: "INTERNAL_SERVER_ERROR", message: "Failed to create user in Supabase" });
    ...
    updateRole: adminProcedure2.input(import_zod2.z.object({ userId: import_zod2.z.number().int().positive(), role: import_zod2.z.enum(["admin", "user"]) })).mutation(({ input, ctx }) => updateUserRole(input.userId, input.role, { id: ctx.user.id, name: ctx.user.name })),
    deleteUser: adminProcedure2.input(import_zod2.z.object({ userId: import_zod2.z.number().int().positive() })).mutation(async ({ input, ctx }) => {
  ...
  onedrive: router({
    ...
    listFiles: protectedProcedure.input(import_zod2.z.object({ folderId: import_zod2.z.string().optional() })).query(async ({ ctx, input }) => {
      const { getDb: getDb2 } = await Promise.resolve().then(() => (init_db(), db_exports));
      const { userOauthConnections: userOauthConnections2 } = await Promise.resolve().then(() => (init_schema(), schema_exports));
      const { eq: eq7 } = await import("drizzle-orm");
      const db = await getDb2();
      ...
      if (existing.length === 0 || !existing[0].accessToken) {
        throw new import_server3.TRPCError({ code: "UNAUTHORIZED", message: "Microsoft OneDrive is not connected" });
      }
        ...
        if (res.status === 401) {
          ...
          if (newAccessToken) {
            ...
            if (retryRes.ok) {
              ...
              throw new import_server3.TRPCError({ code: "UNAUTHORIZED", message: "Token expired, please reconnect" });
            }
          } else {
            throw new import_server3.TRPCError({ code: "UNAUTHORIZED", message: "Token expired, please reconnect" });
          }
        } else {
          throw new import_server3.TRPCError({ code: "INTERNAL_SERVER_ERROR", message: "Failed to fetch files from Microsoft" });
        }
      }
    ...
    syncFile: protectedProcedure.input(import_zod2.z.object({ fileId: import_zod2.z.string(), fileName: import_zod2.z.string() })).mutation(async ({ ctx, input }) => {
      const { getDb: getDb2 } = await Promise.resolve().then(() => (init_db(), db_exports));
    ...
    removeSync: protectedProcedure.input(import_zod2.z.object({ fileId: import_zod2.z.string() })).mutation(async ({ ctx, input }) => {
      const { getDb: getDb2 } = await Promise.resolve().then(() => (init_db(), db_exports));
    ...
    debugSearch: protectedProcedure.input(import_zod2.z.object({ fileId: import_zod2.z.string(), q: import_zod2.z.string(), sheetName: import_zod2.z.string().optional(), limit: import_zod2.z.number().optional() })).query(async ({ ctx, input }) => {
      const { getDb: getDb2 } = await Promise.resolve().then(() => (init_db(), db_exports));
